 ...
 <div id="vanta-globe" class="hero-bg min-h-screen flex items-center justify-center pt-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
            ...
            <div data-aos="fade-up" data-aos-delay="200" class="flex flex-col sm:flex-row justify-center gap-4">
                ...
                <a href="#portfolio" class="bg-transparent border-2 border-white text-blue-600 hover:bg-white hover:text-blue-600 px-6 py-3 rounded-lg font-medium transition duration-300">View Portfolio</a>
            </div>
        </div>
    </div>
