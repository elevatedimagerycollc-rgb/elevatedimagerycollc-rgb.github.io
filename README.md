...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Real Estate Photography | Elevated Imagery</title>
  <link rel="icon" type="image/x-icon" href="/static/favicon.ico">
  <script src="https://cdn.tailwindcss.com"></script>
  <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
  <script src="https://unpkg.com/aos@2.3.1/dist/aos.js"></script>
...
<body class="bg-white">
  ...
  <section class="pt-24 pb-12 text-center">
    <h1 class="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Real Estate Photography</h1>
    <p class="text-gray-600 max-w-2xl mx-auto mb-8">Elegant Homes showcased through stunning aerial and interior photography.</p>
    <a href="index.html#portfolio" class="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700">Back to Portfolio</a>
  </section>
  ...
  <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
      <!-- Example Images -->
      <img src="images/re.example.jpg" alt="Property 1" class="w-full h-64 object-cover rounded-xl shadow-lg">
      <img src="images/re2.jpg" alt="Property 2" class="w-full h-64 object-cover rounded-xl shadow-lg">
      <img src="images/re3.jpg" alt="Property 3" class="w-full h-64 object-cover rounded-xl shadow-lg">
      <img src="images/re4.jpg" alt="Property 4" class="w-full h-64 object-cover rounded-xl shadow-lg">
      <img src="images/re5.jpg" alt="Property 5" class="w-full h-64 object-cover rounded-xl shadow-lg">
      <img src="images/re6.jpg" alt="Property 6" class="w-full h-64 object-cover rounded-xl shadow-lg">
    </div>
  </section>
  ...
  <footer class="bg-gray-900 text-white py-12 mt-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
      <p>© 2025 Elevated Imagery LLC. All rights reserved.</p>
    </div>
  </footer>
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Event Photography | Elevated Imagery</title>
  <link rel="icon" type="image/x-icon" href="/static/favicon.ico">
  <script src="https://cdn.tailwindcss.com"></script>
  <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
  <script src="https://unpkg.com/aos@2.3.1/dist/aos.js"></script>
...
<body class="bg-white">
  ...
  <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
      <!-- Example Images -->
      <img src="images/re1.jpg" alt="Property 1" class="w-full h-64 object-cover rounded-xl shadow-lg">
      <img src="images/re2.jpg" alt="Property 2" class="w-full h-64 object-cover rounded-xl shadow-lg">
      <img src="images/re3.jpg" alt="Property 3" class="w-full h-64 object-cover rounded-xl shadow-lg">
      <img src="images/re4.jpg" alt="Property 4" class="w-full h-64 object-cover rounded-xl shadow-lg">
      <img src="images/re5.jpg" alt="Property 5" class="w-full h-64 object-cover rounded-xl shadow-lg">
